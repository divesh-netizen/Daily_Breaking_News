...
// 1a2592e1eef74ca1b587ba5340178b6e

let source = 'the-hindu';
let apikey = '1a2592e1eef74ca1b587ba5340178b6e';
    ...
    if (this.status === 200) {
        ...
        articles.forEach(function(element, index) {
            let news = `<div class="accordion-item">
                            ...
                            <div id="collapse${index}" class="accordion-collapse collapse" aria-labelledby="headingcollapse${index}"
